            ...
            <AppBar sx={{padding:"5px",background:Modes[1]}} color='transparent' >
				<Stack direction="row" spacing={5}>
					...
					<Stack direction="row"  spacing={isMobile ? 1 : 2} padding="2.5px" display="flex" alignItems="center">
						...
						<Link underline='none' component={ReactRouterDomLink} to="/" sx={{color:Modes[2][0],":hover":{
							color:Modes[2][1]
						}}}>
							home
						</Link>
						<Link underline='none' component={ReactRouterDomLink} to="/roadmap" sx={{color:Modes[2][0],":hover":{
							color:Modes[2][1]
						}}}>
							roadmap
						</Link>
						<Link underline='none' component={ReactRouterDomLink} to="/projects" sx={{color:Modes[2][0],":hover":{
							color:Modes[2][1]
						}}}>
							projects
						</Link>
